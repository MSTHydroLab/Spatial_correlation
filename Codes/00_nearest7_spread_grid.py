...
def build_nearest7_for_grid(
    ...
    grid_id_col: str = "id",
    grid_x_col: str="UTM_Easting",
    grid_y_col: str="UTM_Northing",
    stn_id_col: str = "ID",
...
def main():
    ...
    ap.add_argument("--grid-csv", 
                    default="/mnt/12TB/Sujan/Spatial_correlation/Codes/01_Correlation_and_Variogram/grid_centers_full.csv",
                    help="Grid cell centers CSV (UTM 15N meters).")
    ap.add_argument("--out-csv", default="/mnt/12TB/Sujan/Spatial_correlation/Codes/01_Correlation_and_Variogram/nearest7_spread_grid.csv",
                    help="Output CSV path.")
    ap.add_argument("--grid-id-col", default="id",
                    help="ID column for grid cells.")
    ap.add_argument("--grid-x-col", default="UTM_Easting",
                    help="Grid easting column (m).")
    ap.add_argument("--grid-y-col", default="UTM_Northing",
