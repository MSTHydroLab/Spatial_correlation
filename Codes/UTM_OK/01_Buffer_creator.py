...
def plot_combined_histograms(catchment_name, out_dir, buffer_km_list,OUT_DIR):
    ...
    plt.savefig(OUT_DIR / f"{catchment_name}.png")
    plt.close()
...
def main():
    ...
    # Run for each catchment
    plot_combined_histograms("6892513", OUT_DIR, buffer_km_list,OUT_DIR)
    plot_combined_histograms("6893080", OUT_DIR, buffer_km_list,OUT_DIR)
    plot_combined_histograms("6893390", OUT_DIR, buffer_km_list,OUT_DIR)
