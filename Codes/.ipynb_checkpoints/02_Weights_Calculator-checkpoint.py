...
def pick3_max_spread(ids, dists, bears):
    valid = [
...
def run_event(event_number):
    ...
    for _, row in nei.iterrows():
        ...
        chosen_idx = pick3_max_spread(ids_f, dists_f, bears_f)
    ...
    out_file = BASE_DIR / f"Event_{event_number}_weights.csv"
